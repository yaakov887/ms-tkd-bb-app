 ...
 *
 */
public class ClassListXMLParserSerializer {
	 ...
	 * 
	 */
	public ClassListXMLParserSerializer () {
	...
	throws IllegalArgumentException, IllegalStateException, IOException {
		...
		Iterator<LeadershipClass> iter = class_list.iterator();
		
		for (LeadershipClass lc = iter.next (); lc != null && iter.hasNext (); iter.next ()) {
